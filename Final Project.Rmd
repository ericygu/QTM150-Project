...
EUROPEAN <- DOHM0 %>%
  filter(CUISINE.DESCRIPTION =="Czech"|
...
GLOBAL.SCORES <- data.frame(GLOBAL.NAMES, AVG.GLOBAL.SCORES)

ggplot(GLOBAL.SCORES, aes(GLOBAL.NAMES, AVG.GLOBAL.SCORES)) +
  xlab("Cuisine region") +
  ylab("Average Score") +
...
The average score for most cuisines was around 21 - 24. However, the average score for American restaurants was substantially lower (better in the context of the data) than the average for other countries at about 19. The average score for African restaurants seemed substantially higher (worse) than the average for other countries at about 27.

This pattern matches our expectations because American restaurants received much better scores than any other type of cuisine, which indicates that the inspectors were potentially biased towards cuisines that they were familiar with. Additionally, the fact that African restaurants received worse scores than any other type of cuisine also points to a racial bias in ratings.
